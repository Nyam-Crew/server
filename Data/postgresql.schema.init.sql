...
CREATE TABLE daily_mission (
                               ...
                               completed_by     VARCHAR(16) NOT NULL DEFAULT 'NONE', -- AUTO/MANUAL/NONE
                               created_date     TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP,
                               modified_date    TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP,
                               expire_date      TIMESTAMP   NOT NULL,
                               CONSTRAINT uq_daily UNIQUE (member_id, mission_id, mission_date),
                               CONSTRAINT fk_daily_mission FOREIGN KEY (mission_id) REFERENCES mission(mission_id)
);
...
CREATE TABLE daily_mission_stamp (
                                     ...
                                     CONSTRAINT uq_daily_mission_stamp UNIQUE (member_id, mission_date)
);
