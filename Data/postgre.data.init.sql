...
VALUES ('새해 다짐 챌린지', '1월 첫 주, 매일 운동하고 식단 기록하기 - 뱃지: 작심삼일 극복',
       ...
       ('수분 히어로 챌린지', '일주일 동안 매일 2L 물 마시기 성공 - 뱃지: 망토 물방울',
        'https://nyamnyambucket.s3.ap-northeast-2.amazonaws.com/a8000079-2dec-4c23-9ab9-4c31a0dea01c.png',
        'EVENT_CHALLENGE', CURRENT_TIMESTAMP),
       ('단백질 파워 위크', '5일 연속 매끼 단백질 20g 이상 섭취 - 뱃지: 근육질 달걀',
        'https://nyamnyambucket.s3.ap-northeast-2.amazonaws.com/a8000079-2dec-4c23-9ab9-4c31a0dea01c.png',
        'EVENT_CHALLENGE', CURRENT_TIMESTAMP),
...
VALUES ('첫 식단 기록', '처음으로 식단을 기록',
       ...
       ('프로필 정보 입력 완료', '프로필 정보(키, 몸무게, 활동량) 모두 입력하기',
        'https://nyamnyambucket.s3.ap-northeast-2.amazonaws.com/a8000079-2dec-4c23-9ab9-4c31a0dea01c.png',
        'REGULAR_CHALLENGE', CURRENT_TIMESTAMP),
       ('단백질 권장량 3일 달성', '일일 단백질 권장량 3일 연속 달성',
        'https://nyamnyambucket.s3.ap-northeast-2.amazonaws.com/a8000079-2dec-4c23-9ab9-4c31a0dea01c.png',
        'REGULAR_CHALLENGE', CURRENT_TIMESTAMP),
